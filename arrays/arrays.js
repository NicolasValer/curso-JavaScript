...
const listaDeNimerosMega = [2, 13, 26, 35, 41, 60]
...
//1.
const listaDeCachorro = ["pincher", "pitbull", "dalmata", "pastor alemão", "huskie!"]

const readlineSync = require('readline-sync');

const numero = readlineSync.question('escolha um numero de 0 a 4.');

const segundoItem2 = listaDeCachorro[numero]

console.log(`O cachorro favorito é ${segundoItem2}`)
